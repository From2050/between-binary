...
This homepage constellation is a **simplified preview** of something larger I'm building toward: a space inside a future VR Academy called the Civilization Star Map.

Picture a walkway through open wilderness — no walls, no UI chrome, just terrain underfoot and sky overhead. As you walk, the path itself traces the arc of human progress: tools, language, writing, machines, networks, intelligence. Above you, the sky holds the people and moments who made each step possible — not as static portraits, but as living points of light you can approach, pause beside, and listen to.

The goal isn't a museum. It's closer to a **rite of passage** — a way for whoever walks that path to feel, physically, how hard-won and vast civilization's progress has been, and how much of it rests on people who kept going anyway.

What lives on this page today — orbiting stars, hover to read, click to land here — is the seedling version of that walkway. The constellation is real; the wilderness is still being built.

<Callout type="tip" title="Growing">
I'm gathering a short bio and contribution note for each figure a little at a time. Eventually, clicking a star should lead into a fuller 3D/VR rendering of the walk itself. For now, every star in the sky brings you back to this page.
</Callout>
...
- **Bios for every star** — a contribution note for each of the 45 figures, added gradually
- **The walkway itself** — a full 3D/VR rendering of the Civilization Star Map inside the VR Academy
